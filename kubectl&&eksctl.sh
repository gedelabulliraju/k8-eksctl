...
echo "==============================="
echo "Installing kubectl, eksctl, k9s, helm, and EBS CSI driver"
echo "==============================="
...
# Verification
echo "[7/7] Verifying all installations..."
...
# if [ $? -ne 0 ]; then
#     echo "Failed to install k9s. Please check your internet connection or the installation script."
#     exit 1
# fi
# echo "k9s installed successfully."
